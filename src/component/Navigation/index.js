...
const Navigation = () =>{
  ...
  return (
    <div className='xl:w-[250px] lg:x-[85px] lg:h-screen ml-3 mr-3 flex flex-col max-md:hidden'>
      <div className='p-3'>
        <Image src={logo} alt="" height={40} />
      </div>
      <div className='flex flex-col justify-between flex-1'>
        <div>
          <div className="flex p-3 text-[20px] hover:bg-slate-100 rounded-full cursor-pointer gap-3" onClick={()=>router.push('/posts')}>
            <Image src={home} alt="" height={30} />
            <div className="md:max-xl:hidden">Home</div>
          </div>
          <div className="flex p-3 text-[20px] hover:bg-slate-100 rounded-full cursor-pointer gap-3" onClick={()=>router.push('/find')}>
            <Image src={search} alt="" height={30} />
            <div className="md:max-xl:hidden">Find</div>
          </div>
          <div className="flex p-3 text-[20px] hover:bg-slate-100 rounded-full cursor-pointer gap-3" onClick={()=>router.push('/notifications')}>
            <Image src={bell} alt="" height={30} />
            <div className="md:max-xl:hidden">Notifications</div>
          </div>
          <div className="flex p-3 text-[20px] hover:bg-slate-100 rounded-full cursor-pointer gap-3" onClick={()=>router.push('/bookmarks')}>
            <Image src={bookmark} alt="" height={30} />
            <div className="md:max-xl:hidden">Bookmarks</div>
          </div>
          <div className="flex p-3 text-[20px] hover:bg-slate-100 rounded-full cursor-pointer gap-3" onClick={()=>router.push('/naved2469')}>
            <Image src={profile} alt="" height={30} />
            <div className="md:max-xl:hidden">Profile</div>
          </div>

          <div className='p-3 mt-2 mr-10 bg-blue-400 rounded-full text-center font-bold text-white cursor-pointer hover:bg-blue-500 md:max-xl:hidden'>Post</div>
        </div>

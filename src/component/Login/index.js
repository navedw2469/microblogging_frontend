  ...
  return(
    <div className="flex flex-col items-center h-[625px] gap-3 p-5 pt-20">
      <div className="md:border w-[350px] rounded-lg">
        ...
        <input type="text" id="username" name="username" placeholder="username" className="border w-[270px] h-[36px] m-auto block p-2 mb-2 rounded-lg bg-slate-100"></input>
        <input type="password" id="password" name="password" placeholder="password" className="border w-[270px] h-[36px] m-auto block p-2 mb-2 rounded-lg bg-slate-100"></input>

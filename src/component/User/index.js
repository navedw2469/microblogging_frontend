...
const User = () => {
  ...
  const [PSloading , PSsetLoading] = useState(true);
  ...
  return (
    ...
    <div className="flex justify-center">
      <Navigation />
      <div
        className="w-[625px] h-[100vh] overflow-y-auto border-r border-l"
      ...
      >
        ...
        <div className="p-3 gap-4 flex items-center sticky top-0 bg-opacity-80 bg-white backdrop-filter backdrop-blur-md">
          <Image
            src={back}
            alt=""
            className="h-[40px] w-[40px] rounded-full hover:bg-gray-200 cursor-pointer"
            onClick={() => router.back()}
          />
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3 justify-between">
              <div>
                ...
                <div className="text-[14px] text-gray-700 font-light">
                  @{data?.user_name}
                </div>
              </div>
              {!followed && (
                <div
                  className="px-4 py-2 border-2 rounded-full bg-blue-400 text-white font-bold hover:bg-blue-500 cursor-pointer"
              ...
              {followed && (
                <div
                  className="px-4 py-2 border-2 rounded-full font-bold cursor-pointer hover:bg-slate-100"
        ...
        <div className="flex border-b">
          <div
            className="flex-1 hover:bg-slate-200 cursor-pointer"
            onClick={() => {
              setTab("posts");
            }}
          >
            ...
            {tab === "posts" && (
              <div className="h-[5px] bg-blue-400 rounded-md ml-12 mr-12"></div>
            )}
          </div>
